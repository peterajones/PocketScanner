...
extension Tip {
    ...
    static let all: [Tip] = [
        ...
        Tip(id: "context-menu",
            title: String(localized: "Touch and hold for more", comment: "Tip title"),
            body: String(localized: "Touch and hold any document to move it into a folder, merge it into another scan, or rename it. Folders can be renamed the same way.", comment: "Tip body")),
        Tip(id: "grid",
        ...
        Tip(id: "page-size",
            title: String(localized: "Scans at a real paper size", comment: "Tip title"),
            body: String(localized: "Set Page Size in Settings to US Letter or A4 and your scans come out as true paper-size PDFs, the same size as documents from anywhere else, so they line up side by side. Auto keeps whatever shape the scanner found.", comment: "Tip body")),
        Tip(id: "icloud",
            title: String(localized: "On all your devices", comment: "Tip title"),
            body: String(localized: "With iCloud Drive turned on, your scans sync to your other devices automatically and show up in the Files app. Without it, everything stays on this device. Either way, nothing is ever sent to our servers.", comment: "Tip body")),
        Tip(id: "highlights",
            title: String(localized: "Highlights & handwriting", comment: "Tip title"),
            body: String(localized: "Select text in a scan, then pick a highlight color or strikethrough from the menu that appears. Marks snap to the text Pocket Scanner detects: on printed pages that’s precise; on handwriting or rough scans, detection is looser, so a highlight may sit a bit tall or not line up exactly. Tap a mark to remove it. Your scan itself is never altered.", comment: "Tip body")),
    ]
}
