...
extension Tip {
    ...
    static let all: [Tip] = [
        ...
        Tip(id: "signature",
            title: "Sign with your signature",
            body: "Scan your signature once in Settings, then tap Sign to drop it on any page — move or resize it to fit. For the cleanest cut-out, sign a plain sheet with a bold pen; if the camera can’t find the page edges up close, take a photo instead and crop it."),
        Tip(id: "flat-list",
            title: "One big list",
