...
*Pocket Scanner is built and maintained by Peter Jones as an independent project. The source is public at [github.com/peterajones/PocketScanner](https://github.com/peterajones/PocketScanner) — you can verify the claims above for yourself.*
